...
export default function ReportDetailPage() {
  ...
  if (loading) {
    return <div className="text-center py-12 text-gray-500">{vi.common.loading}</div>;
  }

  if (!report) {
    return <div className="text-center py-12 text-gray-500">Khong tim thay bao cao</div>;
  }
    ...
    <>
      ...
      {report.summary && (
        <div className="card mb-6">
          <h3 className="font-semibold text-gray-900 mb-2">Tom tat</h3>
